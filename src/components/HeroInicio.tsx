...
export default function HeroInicio() {
  return (
    <>
    <div className={`${COLORS["primary"]} h-72 w-full mt-24 p-4 flex flex-col items-center gap-y-4 relative font-montserrat`}>
      ...
      />
        <p className={`${COLORS["text_basic"]}  text-3xl lg:text-5xl pt-16 font-semibold font-montserrat`}>Preparáte para tener</p>
