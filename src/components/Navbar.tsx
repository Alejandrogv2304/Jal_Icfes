...
export default function Navbar() {
  ...
  return (
    <>
      <header className={`${COLORS["primary"]} flex justify-around p-4 font-system text-md font-semibold items-center fixed top-0 w-full z-50 font-montserrat`}>
        {/* Logo */}
        ...
        {/* Menú Móvil  */}
        {isMenuOpen && (
          <div className={`lg:hidden fixed inset-0 ${COLORS["primary"]} z-40 flex flex-col items-center justify-start space-y-6 mt-16 font-montserrat`}>
